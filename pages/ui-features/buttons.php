                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="card-body">
                      ...
                      <p class="card-description">Add class <code>.btn-gradient-{color}</code> for buttons in theme colors</p>
                      <div class="template-demo">
                  ...
                  <div class="col-md-6">
                    <div class="card-body">
                      ...
                      <p class="card-description">Add class <code>.btn-gradient-{color}</code> and <code>.btn-rounded</code></p>
                      <div class="template-demo">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="template-demo">
                    ...
                    <button type="button" class="btn btn-social-icon btn-outline-twitter"><i class="ti-twitter"></i></button>
                  ...
                  <div class="template-demo">
                    ...
                    <button type="button" class="btn btn-social-icon btn-twitter"><i class="ti-twitter"></i></button>
                  ...
                  <div class="template-demo">
                    ...
                    <button type="button" class="btn btn-social-icon btn-twitter btn-rounded"><i class="ti-twitter"></i></button>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="template-demo">
                    ...
                    <button type="button" class="btn btn-social-icon-text btn-twitter"><i class="ti-twitter"></i>Twitter</button>
